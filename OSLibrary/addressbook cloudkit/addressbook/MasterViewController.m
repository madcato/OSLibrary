...
- (void)insertNewObject:(id)sender
{
    ...
    [newManagedObject setValue:@(OSObjectCreated) forKey:@"syncStatus"];
    // Save the context.
    NSError *error = nil;
...
- (NSFetchedResultsController *)fetchedResultsController
{
    ...
    NSEntityDescription *entity = [NSEntityDescription entityForName:@"Person" inManagedObjectContext:[[OSDatabase defaultDatabase] managedObjectContext]];
